...
export class ProgressbarsComponent implements OnInit {
  ...
  constructor() { 
    this.habilidades = [
      ...
      {'habilidad':'Cloud Flare', 'porcentaje':50, 'tipo':'gestion2'},
      {'habilidad':'Google Cloud', 'porcentaje':20, 'tipo':'gestion2'},
      {'habilidad':'Azure', 'porcentaje':20, 'tipo':'gestion2'},
      {'habilidad':'Digital Ocean', 'porcentaje':30, 'tipo':'gestion2'},
      {'habilidad':'Heroku', 'porcentaje':30, 'tipo':'gestion2'},
      ...
      {'habilidad':'Angular', 'porcentaje':75, 'tipo':'frontend'},
      {'habilidad':'React', 'porcentaje':40, 'tipo':'frontend'},
      {'habilidad':'React Native', 'porcentaje':70, 'tipo':'frontend'},
      ...
      {'habilidad':'Bootstrap 4.5', 'porcentaje':100, 'tipo':'frontend'},
      {'habilidad':'Bootstrap 5', 'porcentaje':90, 'tipo':'frontend'},
